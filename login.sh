...
echo -e "\033[1m\033[33m
   ...
   /  |/  /_  _______/ (_)___ ___     / ____(_)___ _/ /_  / /____  _____
  / /|_/ / / / / ___/ / / __ `__ \   / /_  / / __ `/ __ \/ __/ _ \/ ___/
 / /  / / /_/ (__  ) / / / / / / /  / __/ / / /_/ / / / / /_/  __/ /    
/_/  /_/\__,_/____/_/_/_/ /_/ /_/  /_/   /_/\__, /_/ /_/\__/\___/_/     
                                           /____/                       
                                        
   ℙ𝕠𝕨𝕖𝕣𝕖𝕕 𝔹𝕪 𝔻𝕚𝕣𝕖𝕔𝕥 𝔸𝕔𝕥𝕚𝕠𝕟 𝔹𝕒𝕟𝕘𝕝𝕒𝕕𝕖𝕤𝕙
                                      
"
echo -e  "     \e[1m\e[32m▂▃▄▅▆▇▓▒░ \033[1mCoded By \e[33m🅃🅄 🄿🄰🄳🅁🄴\e[1m\e[32m░▒▓▇▆▅▄▃▂"
cd $HOME
cd Termux-Login
cd NETWORK
python network.py
